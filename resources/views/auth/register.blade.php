    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    {!! Form::open(['route' => 'register.create', 'method' => 'get', 'novalidate']) !!}
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="Tipodedocumento" class="col-md-4 col-form-label text-md-right">{{ __('Tipo de documento') }}</label>

                            <div class="col-md-6">
                                <select name="id_documenttypes" id="inputid_documenttypes" class="form-control" required>
